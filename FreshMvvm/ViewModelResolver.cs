...
namespace EsriNeaMvvm
{
    public static class ViewModelResolver
    {
        ...
        {
            var pageModel = EsriIOC.Container.Resolve<T>();
        ...
        {
            var pageModel = EsriIOC.Container.Resolve(type) as BaseViewModel;
            return ResolvePageModel(type, data, pageModel);
        }
        ...
        public static Page ResolvePageModel(Type type, object data, BaseViewModel pageModel)
        {
            ...
            var page = (Page)EsriIOC.Container.Resolve(pageType);
