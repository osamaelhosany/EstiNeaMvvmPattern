...
namespace EsriNeaMvvm
{
    public class PageModelCoreMethods : IPageModelCoreMethods
    {
        ...
        {
            T pageModel = EsriIOC.Container.Resolve<T>();
        ...
        {
            T pageModel = EsriIOC.Container.Resolve<T>();
            TPage page = EsriIOC.Container.Resolve<TPage>();
        ...
        {
            var pageModel = EsriIOC.Container.Resolve(pageModelType) as BaseViewModel;
        ...
        async Task PushPageModelWithPage(Page page, BaseViewModel pageModel, object data, bool modal = false, bool animate = true)
        {
            ...
            {
                INavigationService rootNavigation = EsriIOC.Container.Resolve<INavigationService>(_currentPageModel.CurrentNavigationServiceName);
        ...
        public async Task PopPageModel(bool modal = false, bool animate = true)
        {
            ...
            else
            {
                ...
                INavigationService rootNavigation = EsriIOC.Container.Resolve<INavigationService>(navServiceName);
        ...
        {
            INavigationService rootNavigation = EsriIOC.Container.Resolve<INavigationService>(navigationServiceName);
        ...
        {
            var currentNavigationService = EsriIOC.Container.Resolve<INavigationService>(_currentPageModel.CurrentNavigationServiceName);
            currentNavigationService.NotifyChildrenPageWasPopped();

            EsriIOC.Container.Unregister<INavigationService>(_currentPageModel.CurrentNavigationServiceName);
